...
void usercontrol(void) {
  ...
  while (1) {
    ...
    if (Controller1.ButtonR1.pressing() == 1){
      ...
      Left.spin(forward, Controller1.Axis3.position()/4,percent);
      Right.spin(forward, Controller1.Axis3.position()/4,percent);
    }
    else if (Controller1.Axis1.position(percent) !=0){
      Left.spin(forward, Controller1.Axis1.position()/4,percent);
      Right.spin(reverse, Controller1.Axis1.position()/4,percent);
    }
    else {
