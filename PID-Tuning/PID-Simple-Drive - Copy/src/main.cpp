...
int drivePID(){
  ...
  while(enableDrivePID) {
    ...
    // Potential
    leftError = desiredValue - leftMotorPosition;
    ...
    // Potential
    rightError = desiredValue - rightMotorPosition;
    ...
    double rightLateralMotorPower = (rightError * (kP+.0002) + rightDerivative * kD + rightTotalError * kI);
    ...
    Left.spin(forward, leftLateralMotorPower + leftTurnMotorPower, voltageUnits::volt);
    Right.spin(forward, rightLateralMotorPower - rightTurnMotorPower, voltageUnits::volt);
