...
int drivePID(){
  ...
  while(enableDrivePID) {
    ...
    double leftTurnMotorPower = (leftTurnError * turnkPL + leftTurnDerivative * turnkDL + leftTurnTotalError * turnkIL);
    ...
    double rightTurnMotorPower = (rightTurnError * turnkPR + rightTurnDerivative * turnkDR + rightTurnTotalError * turnkIR);
    
    Brain.Screen.clearScreen();
    Brain.Screen.print(rightTurnMotorPower);

    leftLateralMotorPower += leftTurnMotorPower;

    rightLateralMotorPower += (-1 * rightTurnMotorPower);
